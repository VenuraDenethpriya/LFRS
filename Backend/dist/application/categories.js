...
var createCaregory = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var caategory, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Category_1.default.create(req.body)];
            case 1:
                caategory = _a.sent();
                if (Category_1.default) {
                    return [2 /*return*/, res.status(201).json(caategory).send("You have created a new category")];
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(200).send("You successfully deleteed the category")];
            case 2:
                error_3 = _a.sent();
                next(error_3);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(200).json(category).send("You have updated the category")];
            case 2:
                error_4 = _a.sent();
                next(error_4);
                return [3 /*break*/, 3];
