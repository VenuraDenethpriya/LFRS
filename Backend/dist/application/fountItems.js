...
var createFoundReport = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var foundReport, message, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
                return [4 /*yield*/, FoundReport_1.default.create(req.body)];
            case 1:
                foundReport = _a.sent();
                if (!foundReport) return [3 /*break*/, 6];
                if (!req.body.email) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, utils_1.sendConfirmationEmail)(foundReport.email, foundReport, 'FOUND')];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
                if (!req.body.phoneNo) return [3 /*break*/, 5];
                message = "Hello ".concat(foundReport.name, ", your found item report (Ref: ").concat(foundReport.referanceNo, ") has been created successfully. Thank you!");
                return [4 /*yield*/, (0, utils_1.sendSMS)(req.body.phoneNo, message)];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5: return [2 /*return*/, res.status(201).json(foundReport).send()];
            case 6: return [2 /*return*/, res.status(200).send("Something went wrong")];
            case 7:
                error_1 = _a.sent();
                next(error_1);
                return [3 /*break*/, 8];
...
var getFoundReport = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, referance, category, location, policeStation, district, date, status, _b, limit, _c, offset, query, totalCount, reports, error_2;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                return [4 /*yield*/, FoundReport_1.default.countDocuments(query)];
            case 1:
                totalCount = _d.sent();
                return [4 /*yield*/, FoundReport_1.default.find(query)
...
var getFoundReportById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, foundReport, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, FoundReport_1.default.findById(id).populate('category')];
            case 1:
                foundReport = _a.sent();
                if (!foundReport) {
                    throw new not_found_error_1.default("Could not find FoundReport");
                }
                return [2 /*return*/, res.status(200).json(foundReport).send()];
            case 2:
                error_3 = _a.sent();
                next(error_3);
                return [3 /*break*/, 3];
...
var updateFoundReport = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                updateData = req.body;
                return [4 /*yield*/, FoundReport_1.default.findById(id)];
            case 1:
                existingReport = _a.sent();
                if (!existingReport)
                    throw new not_found_error_1.default("Could not find FoundReport");
                previousStatus = existingReport.status;
                return [4 /*yield*/, FoundReport_1.default.findByIdAndUpdate(id, updateData, { new: true })];
            case 2:
            ...
            case 4:
                ...
                smsMessage = "Hi ".concat(updatedReport.name, ", the status of your found item report (Ref: ").concat(updatedReport.referanceNo, ") has been updated to '").concat(updatedReport.status, "'.");
...
var deleteFoundReport = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, foundReport, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, FoundReport_1.default.findByIdAndDelete(id)];
            case 1:
                foundReport = _a.sent();
                if (!foundReport) {
                    throw new not_found_error_1.default("Could not find FoundReport");
...
//# sourceMappingURL=fountItems.js.map