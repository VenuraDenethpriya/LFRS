    ...
    return (
        <section className="py-12 bg-slate-50 flex justify-center">
            <form action="" className="bg-slate-100 rounded-xl px-4 py-8 max-w-[800px] shadow-2xl">
                ...
                <label className="font-semibold" htmlFor="">Lost Items</label>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    <div className="mr-4 ms:mr-0">
                        <label className="font-semibold" htmlFor="">Date of Loss</label>
                    ...
                    <div>
                        <label className="font-semibold" htmlFor="">Time of Loss</label>
